...
def gcd_calc(random_number1, random_number2):
    ...
    list_div1 = [
        count_n
        for count_n in range(1, random_number1 + 1)
        if random_number1 % count_n == 0
    ]
    list_div2 = [
        count_m
        for count_m in range(1, random_number2 + 1)
        if random_number2 % count_m == 0
    ]

    common_list = [
        index
        for index in list_div1 + list_div2
        if index in list_div1 and index in list_div2
    ]
